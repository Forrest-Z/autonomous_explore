...
#ifndef SRT_EXPLORATION_SRTNODE_HPP
#define SRT_EXPLORATION_SRTNODE_HPP
...
// 	typedef int CellValue;
    ...
    struct SRTNodeParams {
        ...
        SRTNodeParams(Eigen::Vector2d _p, double csx = 0.05, double csy = 0.05, double msx = 5.00, double msy = 5.00,
                      double sd = 0.5, double gft = 0.5);
...
#endif //SRT_EXPLORATION_SRTNODE_HPP
